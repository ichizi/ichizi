$(function () {
    ...
    m[1][1] = m[2][1], a.on("animationend webkitAnimationEnd", function (t) {
        ...
        if (g.toggleClass("playing", !i), i) i = 0, "monster" == w && x.text(u[t(u.length)]), c.text("！"), l.find(
                "span").text("换一个"), clearTimeout(b), document.title = a.text() + "这是一个很无聊的网站，但能解决你的人生一大困扰！选择困难户必备！";
        else {
        ...
        $(this).hasClass("selected") || ($(this).addClass("selected").siblings().removeClass("selected"), w = $(this).data(
            "type"), alert("monster" == w ? "注意！前方高能！" : "还是人类好吃呢Ψ(￣∀￣)Ψ"), k = 0, _hmt.push(["_trackEvent", "type",
                "toggle", w]))
